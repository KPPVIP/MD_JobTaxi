...
Config.gainplayer = math.random(50,100)
Config.gaintsocity = math.random(20,200)

Config.MinimumDistance            = 750 -- Distance minimale de destination du travail NPC depuis le ramassage dans les unités GTA, un nombre plus élevé empêche les 
										-- destinations à proximité.

Config.boss 			= { position = {Pos = {x = 906.90, y = -150.90, z = 74.05  }},}
  
Config.garage 			= { position = {Pos = { x = 897.33, y = -179.16, z = 73.74 }},}

Config.carspawn     	= { position = {Pos = { x = 906.68, y = -185.97, z = 74.02 }},}

Config.vestaire     	= { position = {Pos = { x = 893.75, y = -162.50, z = 76.89 }},}

Config.coffre     	    = { position = {Pos = { x = 898.90, y = -169.30, z = 74.17 }},}  

Config.prendreservice   = { position = {Pos = { x = 909.42, y = -154.18, z = 74.17 }},}  
